  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="ml-2 flex items-center gap-2.5 rounded-xl border border-white/[0.06] bg-white/[0.03] px-3 py-1.5">
          ...
          <div className="hidden sm:block">
            ...
            <p className="text-[10px] text-platinum-500">Executive</p>
          </div>
        </div>
      </div>
    </motion.header>
